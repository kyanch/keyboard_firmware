...
static uint8_t  KB_HID_Init(USBD_HandleTypeDef *pdev,
                              uint8_t cfgidx);

static uint8_t  KB_HID_DeInit(USBD_HandleTypeDef *pdev,
                                uint8_t cfgidx);
...
/**
  ...
  * @retval status
  */
static uint8_t  KB_HID_DataIn(USBD_HandleTypeDef *pdev,
                                uint8_t epnum)
{
